...
#3. Fit the model
max_iterations=10
lr=LogisticRegression(maxIter=max_iterations, tol=1E-6, fitIntercept=True)

print "################ Start fitting the model : html"
col_name="html"
reg_html=OneVsRest(classifier=lr,featuresCol=tfidf_col_name,labelCol=col_name,predictionCol=col_name+"_pred")
Model_html = reg_html.fit(train.toDF())
print "################ Start fitting the model : jquery"
col_name="jquery"
reg_jquery=OneVsRest(classifier=lr,featuresCol=tfidf_col_name,labelCol=col_name,predictionCol=col_name+"_pred")
Model_jquery = reg_jquery.fit(train.toDF())
print "################ Start fitting the model : css"
col_name="css"
reg_css=OneVsRest(classifier=lr,featuresCol=tfidf_col_name,labelCol=col_name,predictionCol=col_name+"_pred")
Model_css = reg_css.fit(train.toDF())
print "################ Start fitting the model : javascript"
col_name="javascript"
reg_javascript=OneVsRest(classifier=lr,featuresCol=tfidf_col_name,labelCol=col_name,predictionCol=col_name+"_pred")
