...
nb = NaiveBayes(featuresCol=tfidf_col_name,labelCol=col_name,predictionCol=col_name+"_pred",rawPredictionCol=col_name+"_pred_raw"
				,smoothing=1,modelType='multinomial')
#		,smoothing=1,modelType='multinomial',thresholds=None)


model = nb.fit(train.toDF())
