...
max_iterations=10
reg_log=LogisticRegression(maxIter=max_iterations, tol=1E-6, fitIntercept=True)
reg=OneVsRest(classifier=reg_log,featuresCol=tfidf_col_name,labelCol=col_name,predictionCol=col_name+"_pred")
