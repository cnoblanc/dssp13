...
df_results['total_len']= df_results['train_len']+df_results['test_len']
...
parquet_fileName=base_path+"keras_models_saved/df_results_Clusters_LightGBM_GridSearch_030"
df_cluster_results.to_parquet(parquet_fileName, engine='fastparquet',compression='GZIP') 


parquet_fileName=base_path+"keras_models_saved/df_results_Details_Clusters_LightGBM_GridSearch_030"
